...
light1=normpdf(swavelength,swavelength(501),delwavelength*fix(length(wavelength)/6));%生成宽谱待测单峰光1
light2=normpdf(swavelength,swavelength(3001),delwavelength*fix(length(wavelength)/3));%生成宽谱待测单峰光2
