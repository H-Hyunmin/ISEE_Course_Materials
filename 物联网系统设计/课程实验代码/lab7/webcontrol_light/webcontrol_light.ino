...
//————————————————————————————————————————————————————————————————————————
#define My_JSON_PACK_1        "{\"id\":\"66666\",\"version\":\"1.0\",\"method\":\"thing.event.property.post\",\"params\":{\"Temperature\":%d.%02d,\"Frequency\":%d.%01d,\"ColorRed\":%d,\"ColorBlue\":%d,\"ColorGreen\":%d,\"IsFlickering\":%d}}\r"
...
bool Update()
{
  ...
  fre1=(int) frequency;
  fre2=(frequency-fre1)*10;
  len = snprintf(ATdata,BUF_LEN_DATA,My_JSON_PACK_1,zs,frac,fre1,fre2,ColorRed,ColorBlue,ColorGreen,IsFlickering);
